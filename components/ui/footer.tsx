    ...
    <footer>
      <div className="py-12 md:py-16">
        ...
        <div className="md:py-5">
          ...
          {/* Top area: Blocks */}
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-6">
            {/* 1st block */}
            <div className="md:col-span-9 lg:col-span-9">
              
              <div className="text-gray-400">
                Transform your gaming experience and influence the future of
                game development with Cycle. Because when it comes to making
                games better, it's your voice that makes all the difference.
              </div>
            </div>
            {/* 2nd and 3rd blocks */}
            <div className="md:col-span-3 lg:col-span-3 grid sm:grid-cols-2 gap-8">
              {/* 2nd block */}
          ...
          <div className="md:flex md:items-center md:justify-between">
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4 mb-4">
              &copy; Cycle.com. All rights reserved.
            </div>
            {/* Social links */}
            <ul className="flex mb-4 md:order-1">
              <li>
                <Link
                  href="https://www.linkedin.com/company/cyclesystems"
