      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400 mb-8">If you’re a player, try Cycle and start giving feedback today. Reach out to us if you can think of new or better ways to improve Cycle.</p>
